...
#  If you insert your 2015 taxable income into the 'calctax' function as an integer, you'll get a full print out of your 
#  2015 tax burden and your effective tax rate.
...
def calctax(taxableincome):
    ...
    if taxableincome < 18450:
        ...
        print "You messed up, homie. Make sure you enter an integer with NO commas, decimal points, etc.!"
